...
export default function Footer(){
  ...
  <div class="mx-auto max-w-screen-xl text-center">
      <a href="#" class="flex justify-center items-center text-2xl font-semibold text-white">
          <svg class="mr-2 h-8" viewBox="0 0 33 33" fill="white" xmlns="http://www.w3.org/2000/svg">
      ...
      <p class="my-6 text-white">Open-source library of over 400+ web components and interactive elements built for better web.</p>
      <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-500">
          <li>
